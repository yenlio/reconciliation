...
import { ReconciliationNapasEntity, ReconciliationACVEntity } from '../../core/entity';
...
export class ReconciliationRepositoryService extends ReconciliationRepository {
  ...
  public updateReconciliationsPartnerNapas(
    ...
    const path = API.API_RECONCILIATION.UPDATE_RECONCILIATIONS;
